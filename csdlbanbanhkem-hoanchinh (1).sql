...
create table sanpham(MaSP char(4) not null PRIMARY KEY, MaLB char(4), TenSP varchar(100), 
										KichThuoc varchar(10), KhoiLuong int, MoTa varchar(1000), NoiDung varchar(1000), Gia float, STATUS tinyint(4) DEFAULT 0,
...
INSERT INTO sanpham  VALUES ('B016', 'LB03',  'Bánh kem sữa chua xoài hảo hạng', 'Lớn', 500, "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", 500000, 0);
...
INSERT INTO sanpham VALUES ('B021', 'LB03','Bánh oreo việt quất', '14-10', 300, "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", 250000, 0); 
...
INSERT INTO sanpham VALUES ('B023', 'LB01','Bánh dâu tây bồng bềnh', '14-10', 300, "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", 300000, 0);
...
INSERT INTO sanpham VALUES ('B026', 'LB03','Bánh kem dứa caramel', 'Lớn', 500, "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", 550000, 0); 

INSERT INTO sanpham VALUES ('B027','LB03', 'Bánh kem dứa hảo hạng', 'Lớn', 500, "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.","Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", 550000, 0);

INSERT INTO sanpham VALUES ('B028', 'LB03','Bánh kem sữa chua dâu tây hảo hạng', 'Lớn', 500, "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", 500000, 0);
...
INSERT INTO sanpham VALUES ('B033','LB01', 'Bánh xoài kem sữa chua', 'Vừa', 500, "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", 400000, 0);

INSERT INTO sanpham VALUES ('B034', 'LB03','Bánh dâu tây kem tươi trái tim', 'Bé', 250, "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.",  "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", 150000, 0); 

INSERT INTO sanpham VALUES ('B035', 'LB03','Bánh dâu tây kem tươi', 'Bé', 250, "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", 150000, 0);
...
INSERT INTO sanpham VALUES ('B038', 'LB01','Bánh kem dâu tây sữa chua Hàn Quốc', 'Nhỏ', 400, "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", 400000, 0); 
...
INSERT INTO sanpham VALUES ('B052','LB04', 'Bánh công chúa Elsa', 'Vừa', 450, "Những chiếc bánh kem ngộ nghĩnh với tạo hình những nhân vật hoạt hình xinh đẹp và độc đáo sẽ là món quà vô cùng ý nghĩa dành cho các bé yêu nhà bạn nhân dịp sinh nhật!", "Những chiếc bánh kem ngộ nghĩnh với tạo hình những nhân vật hoạt hình xinh đẹp và độc đáo sẽ là món quà vô cùng ý nghĩa dành cho các bé yêu nhà bạn nhân dịp sinh nhật!", 350000, 0); INSERT INTO sanpham VALUES ('B053','LB04', 'Bánh công chúa váy trắng', 'Vừa', 450, "Những chiếc bánh kem ngộ nghĩnh với tạo hình những nhân vật hoạt hình xinh đẹp và độc đáo sẽ là món quà vô cùng ý nghĩa dành cho các bé yêu nhà bạn nhân dịp sinh nhật!", "Những chiếc bánh kem ngộ nghĩnh với tạo hình những nhân vật hoạt hình xinh đẹp và độc đáo sẽ là món quà vô cùng ý nghĩa dành cho các bé yêu nhà bạn nhân dịp sinh nhật!", 350000, 0); 

INSERT INTO sanpham VALUES ('B054','LB04', 'Bánh kem Noah', 'Vừa', 450, "Những chiếc bánh kem ngộ nghĩnh với tạo hình những nhân vật hoạt hình xinh đẹp và độc đáo sẽ là món quà vô cùng ý nghĩa dành cho các bé yêu nhà bạn nhân dịp sinh nhật!", "Những chiếc bánh kem ngộ nghĩnh với tạo hình những nhân vật hoạt hình xinh đẹp và độc đáo sẽ là món quà vô cùng ý nghĩa dành cho các bé yêu nhà bạn nhân dịp sinh nhật!", 350000, 0);

INSERT INTO sanpham VALUES ('B055', 'LB04','Bánh sinh nhật Doremon', 'Vừa', 450, "Những chiếc bánh kem ngộ nghĩnh với tạo hình những nhân vật hoạt hình xinh đẹp và độc đáo sẽ là món quà vô cùng ý nghĩa dành cho các bé yêu nhà bạn nhân dịp sinh nhật!", "Những chiếc bánh kem ngộ nghĩnh với tạo hình những nhân vật hoạt hình xinh đẹp và độc đáo sẽ là món quà vô cùng ý nghĩa dành cho các bé yêu nhà bạn nhân dịp sinh nhật!", 350000, 0);  

INSERT INTO sanpham VALUES ('B056', 'LB04','Bánh thiên thần tím', 'Vừa', 450, "Những chiếc bánh kem ngộ nghĩnh với tạo hình những nhân vật hoạt hình xinh đẹp và độc đáo sẽ là món quà vô cùng ý nghĩa dành cho các bé yêu nhà bạn nhân dịp sinh nhật!", "Những chiếc bánh kem ngộ nghĩnh với tạo hình những nhân vật hoạt hình xinh đẹp và độc đáo sẽ là món quà vô cùng ý nghĩa dành cho các bé yêu nhà bạn nhân dịp sinh nhật!", 350000, 0);  
...
INSERT INTO sanpham VALUES ('B059', 'LB03','Combo 3 bánh mini', 'Bé', 450, "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", 350000, 0);

INSERT INTO sanpham VALUES ('B060','LB03', 'Bánh kem Socola cherry', 'Vừa', 450, "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", "Từ những quả trái cây tươi, chua ngọt hòa quyện với cốt bánh mềm mịn, béo ngậy.  được lựa chọn kĩ lưỡng từ những loại trái cây nhập khẩu, kết hợp với lớp kem đặc trưng béo ngọt kem và lớp bông lan mềm, tơi xốp hòa quyện lại với nhau tạo nên hương vị khó cưỡng, bạn hay mua thử ngay nhé.", 350000, 0); 
...
INSERT INTO sanpham VALUES ('B083','LB05', 'Bánh mousse chanh leo dâu tây', 'Vừa', 500, "Mousse là dòng bánh ngọt được sử dụng làm món tráng miệng hoặc ăn vặt đến từ kinh đô Pháp. Bánh gồm có 2 lớp, lớp kem ở trên là lớp kem mịn, khi ăn sẽ có vị ngọt, mát và thấm nhanh vào đầu lưỡi của người thưởng thức.", "Mousse là dòng bánh ngọt được sử dụng làm món tráng miệng hoặc ăn vặt đến từ kinh đô Pháp. Bánh gồm có 2 lớp, lớp kem ở trên là lớp kem mịn, khi ăn sẽ có vị ngọt, mát và thấm nhanh vào đầu lưỡi của người thưởng thức.", 400000, 0);
...
INSERT INTO sanpham VALUES ('B092','LB05', 'Bánh mousse xoài hạnh nhân', 'Vừa', 500, "Mousse là dòng bánh ngọt được sử dụng làm món tráng miệng hoặc ăn vặt đến từ kinh đô Pháp. Bánh gồm có 2 lớp, lớp kem ở trên là lớp kem mịn, khi ăn sẽ có vị ngọt, mát và thấm nhanh vào đầu lưỡi của người thưởng thức.","Mousse là dòng bánh ngọt được sử dụng làm món tráng miệng hoặc ăn vặt đến từ kinh đô Pháp. Bánh gồm có 2 lớp, lớp kem ở trên là lớp kem mịn, khi ăn sẽ có vị ngọt, mát và thấm nhanh vào đầu lưỡi của người thưởng thức.", 400000, 0);  
...
CREATE table anhsp(MaAnhSP char(10) not null PRIMARY KEY, MaSP char(4) not null, Anh varchar(40), status TINYINT(10), CONSTRAINT f_msp FOREIGN KEY(MaSP) REFERENCES sanpham(MaSP));

-- --

INSERT INTO anhsp VALUES('ASP01-1', 'B001','img/product/B001/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP01-2','B001','img/product/B001/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP01-3','B001','img/product/B001/banh3.jpg', 0);
INSERT INTO anhsp VALUES('ASP01-4','B001','img/product/B001/banh4.jpg', 0);

INSERT INTO anhsp VALUES('ASP02-1','B002','img/product/B002/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP02-2','B002','img/product/B002/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP02-3','B002','img/product/B002/banh3.jpg', 0);
INSERT INTO anhsp VALUES('ASP02-4','B002','img/product/B002/banh4.jpg', 0);

INSERT INTO anhsp VALUES('ASP03-1','B003','img/product/B003/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP03-2','B003','img/product/B003/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP03-3','B003','img/product/B003/banh3.jpg', 0);
INSERT INTO anhsp VALUES('ASP03-4','B003','img/product/B003/banh4.jpg', 0);

INSERT INTO anhsp VALUES('ASP04-1','B004','img/product/B004/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP04-2','B004','img/product/B004/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP04-3','B004','img/product/B004/banh3.jpg', 0); 

INSERT INTO anhsp VALUES('ASP05-1','B005','img/product/B005/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP05-2','B005','img/product/B005/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP05-3','B005','img/product/B005/banh3.jpg', 0); 

INSERT INTO anhsp VALUES('ASP06-1','B006','img/product/B006/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP06-2','B006','img/product/B006/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP06-3','B006','img/product/B006/banh3.jpg', 0); 
  
INSERT INTO anhsp VALUES('ASP07-1','B007','img/product/B007/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP07-2','B007','img/product/B007/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP07-3','B007','img/product/B007/banh3.jpg', 0); 

INSERT INTO anhsp VALUES('ASP08-1','B008','img/product/B008/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP08-2','B008','img/product/B008/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP08-3','B008','img/product/B008/banh3.jpg', 0); 
 
INSERT INTO anhsp VALUES('ASP09-1','B009','img/product/B009/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP09-2','B009','img/product/B009/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP09-3','B009','img/product/B009/banh3.jpg', 0);
INSERT INTO anhsp VALUES('ASP09-4','B009','img/product/B009/banh4.jpg', 0);

INSERT INTO anhsp VALUES('ASP10-1','B010','img/product/B010/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP10-2','B010','img/product/B010/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP10-3','B010','img/product/B010/banh3.jpg', 0);
INSERT INTO anhsp VALUES('ASP10-4','B010','img/product/B010/banh4.jpg', 0);
 
INSERT INTO anhsp VALUES('ASP11-1','B011','img/product/B011/banh1.jpg', 0);
INSERT INTO anhsp VALUES('AS
banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP89-3','B089','img/product/B089/banh3.jpg', 0);
  
INSERT INTO anhsp VALUES('ASP90-1','B090','img/product/B090/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP90-2','B090','img/product/B090/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP90-3','B090','img/product/B090/banh3.jpg', 0);
 
INSERT INTO anhsp VALUES('ASP91-1','B091','img/product/B091/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP91-2','B091','img/product/B091/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP91-3','B091','img/product/B091/banh3.jpg', 0); 
INSERT INTO anhsp VALUES('ASP91-4','B091','img/product/B091/banh4.jpg', 0);

INSERT INTO anhsp VALUES('ASP92-1','B092','img/product/B092/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP92-2','B092','img/product/B092/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP92-3','B092','img/product/B092/banh3.jpg', 0); 
INSERT INTO anhsp VALUES('ASP92-4','B092','img/product/B092/banh4.jpg', 0);
 
INSERT INTO anhsp VALUES('ASP93-1','B093','img/product/B093/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP93-2','B093','img/product/B093/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP93-3','B093','img/product/B093/banh3.jpg', 0); 
INSERT INTO anhsp VALUES('ASP93-4','B093','img/product/B093/banh4.jpg', 0);
 
INSERT INTO anhsp VALUES('ASP94-1','B094','img/product/B094/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP94-2','B094','img/product/B094/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP94-3','B094','img/product/B094/banh3.jpg', 0);

INSERT INTO anhsp VALUES('ASP95-1','B095','img/product/B095/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP95-2','B095','img/product/B095/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP95-3','B095','img/product/B095/banh3.jpg', 0); 
INSERT INTO anhsp VALUES('ASP95-4','B095','img/product/B095/banh4.jpg', 0);

INSERT INTO anhsp VALUES('ASP96-1','B096','img/product/B096/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP96-2','B096','img/product/B096/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP96-3','B096','img/product/B096/banh3.jpg', 0); 
INSERT INTO anhsp VALUES('ASP96-4','B096','img/product/B096/banh4.jpg', 0);

INSERT INTO anhsp VALUES('ASP97-1','B097','img/product/B097/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP97-2','B097','img/product/B097/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP97-3','B097','img/product/B097/banh3.jpg', 0); 
INSERT INTO anhsp VALUES('ASP97-4','B097','img/product/B097/banh4.jpg', 0);

INSERT INTO anhsp VALUES('ASP98-1','B098','img/product/B098/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP98-2','B098','img/product/B098/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP98-3','B098','img/product/B098/banh3.jpg', 0);

INSERT INTO anhsp VALUES('ASP99-1','B099','img/product/B099/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP99-2','B099','img/product/B099/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP99-3','B099','img/product/B099/banh3.jpg', 0);

INSERT INTO anhsp VALUES('ASP100-1','B100','img/product/B100/banh1.jpg', 0);
INSERT INTO anhsp VALUES('ASP100-2','B100','img/product/B100/banh2.jpg', 0);
INSERT INTO anhsp VALUES('ASP100-3','B100','img/product/B100/banh3.jpg', 0);
...
INSERT INTO HOADON VALUES('HD01', 'AD02', '2022/10/12','1 nến 2 dĩa', 600000, 0);
INSERT INTO HOADON VALUES('HD02', 'AD04', '2022/10/19','1 nến 2 dĩa', 300000, 1);
INSERT INTO HOADON VALUES('HD03', 'AD05', '2022/10/12','1 nến 2 dĩa', 900000, 0);
INSERT INTO HOADON VALUES('HD04', 'AD02', '2022/9/23','1 nến 2 dĩa', 300000, 1);
INSERT INTO HOADON VALUES('HD05', 'AD05', '2022/10/21','1 nến 2 dĩa', 1200000, 0);
INSERT INTO HOADON VALUES('HD06', 'AD03', '2022/10/12','1 nến 2 dĩa', 600000, 0);
INSERT INTO HOADON VALUES('HD07', 'AD03', '2022/5/6','1 nến 2 dĩa', 300000, 2);
INSERT INTO HOADON VALUES('HD08', 'AD01', '2022/8/12','1 nến 2 dĩa', 300000, 0);
INSERT INTO HOADON VALUES('HD09', 'AD06', '2022/7/15','1 nến 2 dĩa', 300000, 1);
INSERT INTO HOADON VALUES('HD10', 'AD07', '2022/11/7','1 nến 2 dĩa', 300000, 0);
INSERT INTO HOADON VALUES('HD11', 'AD08', '2022/1/19','1 nến 2 dĩa', 900000, 1);
INSERT INTO HOADON VALUES('HD12', 'AD02', '2023/1/8','1 nến 2 dĩa', 300000, 0);
INSERT INTO HOADON VALUES('HD13', 'AD10', '2023/1/8','1 nến 2 dĩa', 600000, 2);
...
create table Comments(IdCmt INT PRIMARY KEY AUTO_INCREMENT,MaSP CHAR(4) not null, ID CHAR(4)  not null , BinhLuan VARCHAR(1000), NgayBL datetime, STATUS tinyint(4) DEFAULT 0);
...
CREATE TABLE BLOG (MABLOG CHAR(4) PRIMARY KEY,
                    TIEUDE VARCHAR(255),
									 ...
									 STATUS TINYINT(4) DEFAULT(0));
 --
INSERT INTO BLOG VALUES('BL01', 'Giải mã sức hút của bánh kem hiện đại', 'Trong những bữa tiệc quan trọng bánh kem góp phần mang đến cho không khí thêm phần hoàn hảo. Sự xuất hiện của bánh kem hiện đại như một bước ngoặt mới...', 'img/blog/blog1.jpg', '2022/10/22', 'Đời Sống', 'Hiện đại',0);
INSERT INTO BLOG VALUES('BL02', 'Tổng hợp cách bảo quản bánh kem cực đơn giản' , 'Các loại bánh kem khi không dùng hết hoặc chưa dùng đến bạn đều phải bảo quản đúng cách, để giúp bánh giữ nguyên hương vị. Cùng tìm hiểu cách bảo quản bánh kem cực đơn giản...', 'img/blog/blog2.jpg','2022/10/22', 'Đời Sống', 'Bảo quản bánh',0);
INSERT INTO BLOG VALUES('BL03','Chọn bánh kem cho những ngày kỷ niệm ý nghĩa', 'Ngày nay, bánh kem không chỉ xuất hiện vào duy nhất sinh nhật mà bất cứ dịp kỷ niệm nào cũng có thể sử dụng. Cùng tìm hiểu các dịp kỷ niệm ý nghĩa nên sử dụng bánh kem và cách chọn sao cho phù hợp nhất...', 'img/blog/blog3.jpg', '2022/10/22', 'Kỉ niệm', 'Chọn bánh',0);
INSERT INTO BLOG VALUES('BL04', 'Tại sao sinh nhật lại quan trọng đến thế?', 'Ai cũng biết rằng sinh nhật là một ngày đặc biệt đối với tất cả mọi người. Là sự kiện đánh dấu ngày ra đời, đó như là một điều mặc định khi nói về ý nghĩa của ngày sinh...', 'img/blog/blog4.jpg', '2022/10/22', 'Đời Sống', 'Ý nghĩa bánh',0);

/*=========================================CT Blog=========================================*/

		CREATE TABLE CTBLOG(MACTB CHAR(6) PRIMARY KEY,
											MABLOG CHAR(4),
											DEMUC VARCHAR(100),
											CHITIET VARCHAR(1000),
											CONSTRAINT f_mbl FOREIGN KEY(MABLOG) REFERENCES BLOG(MABLOG));
	--
	INSERT INTO CTBLOG VALUES('CB01-1','BL01', 'Vì sao bánh kem hiện đại được yêu thích đến vậy?', 'Sở dĩ bánh kem được làm theo phong cách hiện đại được mọi người ưa chuộng vì nhiều lý do. Nhưng phải nhắc đến đó là hương vị bánh thơm ngon, kiểu dáng độc đáo, kích thước và màu sắc đa dạng. Bên cạnh đó phải kể đến những điểm đặc biệt sau đây.');
	INSERT INTO CTBLOG VALUES('CB01-2','BL01', '1. Tất cả nguyên liệu đều là tự nhiên.', 'Kế thừa tinh hoa ẩm thực cũ được sáng tạo, thay đổi phù hợp với xu thế mới của thời đại, chiếc bánh kem còn là món ăn tốt cho sức khỏe. Dưới bàn tay khéo léo của những người thợ làm bánh cho ra đời sản phẩm đẹp và độc đáo. Bánh kem hiện đại sử dụng nguyên liệu tự nhiên không chứa chất độc hại. Màu sắc nhẹ nhàng không sử dụng hóa chất.
...
Hãy đặt mua bánh kem hiện đại để những bữa tiệc trở nên ý nghĩa hơn. Đến với Tiệm bánh Hạnh Phúc quý khách sẽ được chọn lựa một trong số rất nhiều kiểu bánh đẹp. Được sản xuất từ nguyên liệu tươi ngon, không chứa chất bảo quản sẽ khiến bạn hài lòng. Nhấc máy gọi ngay cho chúng tôi theo số Hotline 0987654321 để được phục vụ.');
 ...
 INSERT INTO CTBLOG VALUES('CB02-1','BL02','','Các loại bánh kem thông thường trên thị trường hiện nay, nếu được bảo quản đúng cách trong tủ chuyên dụng sẽ có thể dùng được trong 5 - 7 ngày mà không lo hư hỏng. Còn nếu bạn bảo quản bánh kem trong tủ lạnh ở ngăn mát thì có thể an tâm sử dụng trong vòng 2 - 3 ngày.');
	INSERT INTO CTBLOG VALUES('CB02-2', 'BL02','1. Cách bảo quản bánh kem trong tủ lạnh','Bạn có thể cho bánh kem và hộp đựng hoặc bọc kín bánh lại rồi cho vào tủ lạnh, giữ ở mức nhiệt 2 - 8 độ C. Với cách bảo quản này bánh kem có thể dùng được trong vòng 2 - 3 ngày. Tuy nhiên, lớp kem bánh thường sẽ bị khô lại, giảm hương vị thơm ngon, mềm xốp vốn có.
Khi bảo quản bánh kem trong tủ lạnh bạn cần lưu ý không được để bánh gần các loại thực phẩm có mùi, các loại thực phẩm này có thể gây ảnh hưởng đến mùi vị của bánh kem. Hơn nữa, bạn cần phải bọc kín bánh lại để vi khuẩn trong tủ không xâm nhập được vào bánh.');
	INSERT INTO CTBLOG VALUES('CB02-3', 'BL02','2. Cách bảo quản bánh kem khi không có tủ lạnh','Bánh kem nếu không bảo quản trong tủ lạnh bạn có thể dùng một vài lát bánh mì, bánh mì sandwich hoặc bánh bông lan với kích thước vừa với lát cắt dở của bánh kem, dùng tăm tre cố định lại cho bánh mì che được hết lát cắt của bánh kem. Sau đó dùng màng bọc thực phẩm hoặc túi nilon bọc thật kín bánh kem lại.
Với phương pháp này bạn có thể bảo quản bánh kem ở điều kiện thường và dùng trong 5 - 7 tiếng đồng hồ. Các lát bánh mì sẽ giúp vi khuẩn không xâm nhập được vào cốt bánh bên trong, màng bọc giúp lớp kem không bị khô, không nhiễm khuẩn.');
	INSERT INTO CTBLOG VALUES('CB02-4','BL02','3. Cách nhận biết bánh kem bị hỏng','Lớp kem trên bề mặt bánh bị phù lên, không còn giữ nguyên hình dáng ban đầu nữa, khi ngửi có mùi lạ, không thơm như lúc mới mua, mới làm bánh.
...
CREATE table log(id INT AUTO_INCREMENT NOT NULL PRIMARY KEY, level TINYINT(4) not null DEFAULT(0), userid char(4), src varchar(255) not null DEFAULT('none'), content LONGTEXT, creatAt datetime DEFAULT(NOW()), status TINYINT(4) not null DEFAULT(0));
