                            ...
                            <ul class="filter__item-menu dropdown-menu scrollbar-dropdown" aria-labelledby="filter-sort"
                                ...
                                <%
                                    ...
                                    for (String s : listOption) {
                                        ...
                                        if (s.equals(val)) {
                                %>
                                <li><a class="text-pink" onclick="filterProduct(false, '<%=val%>')"
                                       href="ListBlog-admin?sortValue=<%=val%>" selected="true"
                                       value="<%=val%>"><%=val%>
                                </a></li>
                                <%} else {%>
                                <li><a id="sortValue" class="text-pink" href="ListBlog-admin?sortValue=<%=s%>"
                                       onclick="filterProduct(false, '<%=s%>')" value="<%=s%>"><%=s%>
                                </a></li>
                                <%}%>
                                <%}%>
                            </ul>
                ...
                <div class="main__table-wrap">
                    <table class="main__table">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="main__table-text"><%=blog.getCategory()%>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="main__table-text"><%=blog.getDate()%>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="main__table-btns">
                                    ...
                                    <%if (BlogService.findById(blog.getId()).getStatus() == -1) {%>
                                    <a href="#modal-status-unlock<%=i%>"
                                       class="main__table-btn <%=main__btn%> open-modal">
                                        <i class="fa fa-lock"></i>
                                    </a>
                                    <%} else {%>
                                    <a href="#modal-status-lock<%=i%>"
                                       class="main__table-btn <%=main__btn%> open-modal">
                                    ...
                                    <% } %>
                                    <% if (user.getIsedit() == 1 || user.getRole() == 2) { %>
                                    <a href="EditBlog?idB=<%=blog.getId()%>"
