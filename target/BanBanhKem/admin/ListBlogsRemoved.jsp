...
<!-- main content -->
<% List<Blog> blogList = BlogService.getDataRemove();%>
        ...
        <div class="main__table-wrap">
          <table class="main__table">
            ...
            <tr>
              ...
              <td>
                <div class="main__table-text main__table-text--red">Đã xóa</div>
              </td>
              <td>
            ...
            <!-- modal delete -->
            <div id="modal-restore<%=i%>" class="zoom-anim-dialog mfp-hide modal">
              <form method="post" action="RestoreBlog">
                <h6 class="modal__title">Khôi phục Tin Tức</h6>
                <p class="modal__text">Bạn có chắc muốn khôi phục bài viết này?</p>
