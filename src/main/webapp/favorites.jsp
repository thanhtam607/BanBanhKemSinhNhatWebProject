                ...
                <div class="sidebar">
                    <div class="sidebar__item">
                        ...
                        <ul class="slidebar__loaibanh">
                            ...
                            %>
                            <li class="text__loaibanh"><a
                                    href="ProductFilter?title=<%=lb.getName()%> &filter=<%=lb.getName()%>"><%=lb.getName()%>
                            </a></li>
                            <%}%>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="filter__found">
                                <h6><span
                                        id="totalFav2"><%=listFavorite != null ? listFavorite.totalProduct() : "0"%></span>
                                    Sản phẩm</h6>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6" id="<%=id%>">
                        <div class="product__item">
                            <div class="product__item__pic set-bg"
                                 data-setbg="<%=fav.getSp().getListImg().get(0).getImg()%>">
                                <ul class="product__item__pic__hover">
                                    <%if (auth == null) {%>
                                    <li><a onclick="notLogged()"><i class="fa fa-heart"></i></a></li>
                                    <li><a onclick="notLogged()"><i class="fa fa-shopping-cart"></i></a></li>
                                    <% } else { %>
                                    <li><a onclick="removeToFav('<%=fav.getSp().getId()%>')"><i class="fa fa-heart"></i></a>
                                    </li>
                                    <li><a onclick="addToCartI('<%=fav.getSp().getId()%>')"><i
                                            class="fa fa-shopping-cart"></i></a></li>
                                    <%}%>
                                </ul>
                            </div>
                            <div class="product__item__text">
                                <h6><a href="ProductDetail?id=<%=fav.getSp().getId()%>"><%=fav.getSp().getName()%>
                                </a></h6>
