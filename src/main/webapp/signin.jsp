            ...
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                <form action="./doSignin" method="post" class="bg-pink rounded p-4 p-sm-5 my-4 mx-3">
                    ...
                    <div class="btn-google col-12">
                        <a href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile&20openid&redirect_uri=http://banbanhkem.ddns.net:81/BanBanhKem/LoginGoogle&response_type=code
