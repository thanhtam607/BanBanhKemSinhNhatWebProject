...
<!-- main content -->
<% List<TypeOfCake> list = ProductService.getListTypeRemove();%>
      ...
      <div class="col-12 bg-pink">
        <div class="main__table-wrap">
          <table class="main__table">
            ...
            <tr>
              ...
              <td>
                <div class="main__table-btns">
                  <a href="#modal-restore<%=i%>" class="main__table-btn main__table-btn--delete open-modal">
            ...
            <!-- modal delete -->
            <div id="modal-restore<%=i%>" class="zoom-anim-dialog mfp-hide modal" style="height: 300px">
              <form method="post" action="restoreTypeOfCake">
                <h6 class="modal__title">Khôi phục danh mục</h6>
                <p class="modal__text  text-danger">Việc khôi phục danh mục sẽ khôi phục luôn những sản phẩm liên quan </p>
                <p class="modal__text font-size-20">Bạn có chắc khôi phục danh mục này?</p>
                <div class="modal__btns">
                  <input style="display: none" name="idType" value="<%=list.get(i).getIdType()%>">
                  <button class="modal__btn modal__btn--apply" type="submit">Khôi phục</button>
