...
<%--<%@ page import="vn.edu.hcmuaf.model.vn.edu.hcmuaf.fit.Receipt" %>--%>
<%--<%@ page import="vn.edu.hcmuaf.model.vn.edu.hcmuaf.fit.Bill_Detail" %>--%>
<%--<%@ page import="vn.edu.hcmuaf.model.vn.edu.hcmuaf.fit.Bill_Detail" %>--%>
<%--<%@ page import="vn.edu.hcmuaf.service.vn.edu.hcmuaf.fit.InforService" %>--%>
