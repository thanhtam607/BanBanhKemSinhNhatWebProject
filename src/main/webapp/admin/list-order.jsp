                            ...
                            <ul class="filter__item-menu dropdown-menu scrollbar-dropdown"
                                ...
                                <%
                                    ...
                                    for (String s : listOption) {
                                        ...
                                        if (s.equals(val)) {
                                %>
                                <li><a class="text-pink" href="ListReceipt_full_Admin?sortValue=<%=val%>"
                                       selected="true" value="<%=val%>"><%=val%>
                                </a></li>
                                <%} else {%>
                                <li><a id="sortValue" class="text-pink" href="ListReceipt_full_Admin?sortValue=<%=s%>"
                                       value="<%=s%>"><%=s%>
                                </a></li>
                                <%}%>
                                <%}%>
                            ...
                            <td>
                                <div class="main__user">
                                    ...
                                    <div class="main__meta">
                                        <h3><%=UserService.findById(rc.getMakh()).getName()%>
                                        </h3>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="main__table-text"><%=rc.getExport_date()%>
                                </div>
                            </td>
                            <td>
                                <div class="main__table-text"><%=rc.getAddress()%>
                                </div>
                            </td>
                            <td>
                                <div class="main__user breaklineNamePro"><%=rc.getNote()%>
                                </div>
                            </td>
                            <td>
