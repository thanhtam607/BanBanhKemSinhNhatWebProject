...
add MISSINGDATE DATETIME;
ALTER TABLE PUBLICKEY
add REPORTDATE DATETIME;
ALTER TABLE PUBLICKEY ADD CONSTRAINT chk1 CHECK (MISSINGDATE >= CREATEDATE);
ALTER TABLE PUBLICKEY ADD CONSTRAINT chk2 CHECK (MISSINGDATE <= REPORTDATE);